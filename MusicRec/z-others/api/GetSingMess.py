...
class GetSingMess:
    def __init__(self):
        ...
        # 歌曲id
        self.song_id_file = "newdata/song_mess/song_mess_all.txt"
        self.sings_mess_file = "./newdata/sing_mess/sings_mess_all.txt"
        self.error_sing_list = list()
        self.error_sing_file = "./newdata/sing_mess/sings_mess_error_1.txt"
    ...
    def getSingMess(self):
        ...
        for id in self.sing_ids:
            try:
                ...
                writeToFile(self.sings_mess_file, ",".join(artist_list))
            except Exception as e:
                print(e)
        ...
        if self.error_sing_list.__len__() != 0:
            ...
            writeToFile(self.error_sing_file, "\n".join(self.error_sing_list))
        print("歌手信息获取完成 ...")
