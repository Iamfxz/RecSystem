...
class User(models.Model):
    ...
    u_password = models.CharField(blank=False, max_length=3000, verbose_name="用户密码")
    u_phone = models.CharField(blank=False, max_length=64, verbose_name='用户手机')
    ...
    u_sign = models.TextField(blank=True, max_length=10000, verbose_name="用户签名")
